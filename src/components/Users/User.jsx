...
export const User = ({ id, email, first_name, last_name, avatar, onClickPlus, isInvited}) => (
  <li>
    <div>
    ...
    <img onClick={()=>onClickPlus(id)} className="action" src={`/assets/${isInvited ? "minus" : "plus"}.svg`} alt="Action" />
  </li>
);
